        ...
        context.checking(new Expectations() {
            {
                ...
                allowing(cswRecordList.get(0)).getOnlineResourcesByType(AbstractCSWOnlineResource.OnlineResourceType.WMS, AbstractCSWOnlineResource.OnlineResourceType.WMTS, AbstractCSWOnlineResource.OnlineResourceType.WFS);
                ...
                allowing(cswRecordList.get(1)).getOnlineResourcesByType(AbstractCSWOnlineResource.OnlineResourceType.WMS, AbstractCSWOnlineResource.OnlineResourceType.WMTS, AbstractCSWOnlineResource.OnlineResourceType.WFS);
                ...
                allowing(cswRecordList.get(2)).getOnlineResourcesByType(AbstractCSWOnlineResource.OnlineResourceType.WMS, AbstractCSWOnlineResource.OnlineResourceType.WMTS, AbstractCSWOnlineResource.OnlineResourceType.WFS);
