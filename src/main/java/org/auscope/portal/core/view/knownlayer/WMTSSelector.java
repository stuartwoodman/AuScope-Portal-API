...
/**
 * Used for selecting individual WMTS's
 *
 */
public class WMTSSelector implements KnownLayerSelector {
    ...
    /**
     * @param layerName The layerName that identifies which WMTS this KnownLayer is
     *                  identifying
     */
    public WMTSSelector(String layerName) {
        this.layerName = layerName;
    }

    /**
     * @param layerName        The layerName that identifies which WMS this
     *                         KnownLayer is identifying
     * @param serviceEndpoints A list of the end points that will either be included
     *                         or excluded from the WMS, depending on the value of
     *                         includeEndpoints
     * @param includeEndpoints A flag indicating whether the listed service end
     *                         points will be included or excluded from the WMS
     */
    public WMTSSelector(String layerName, String[] serviceEndpoints, boolean includeEndpoints) {
        this.layerName = layerName;
    ...
    /**
     * Gets all related layer names (layers that are related to this WMS but should
    ...
    /**
     * Sets all related layer names (layers that are related to this WMS but should
     * not be used for display).
     *
    ...
    public RelationType isRelatedRecord(CSWRecord record) {
        ...
        for (AbstractCSWOnlineResource onlineResource : wmtsResources) {
    ...
    public String toString() {
        return "WMTSSelector [layerName=" + layerName + ", relatedLayerNames=" + Arrays.toString(relatedLayerNames)
